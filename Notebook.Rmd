...
The main thing I want to do with the data munging is to have all the select and filter and join
work happen in the databases, then import a reduced dataset for mutates and removing duplicates
in R. 

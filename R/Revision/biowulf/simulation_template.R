...
data_path <- '/data/dasgupab/USRDS2015/data/biowulf'
output_path <- '/data/dasgupab/USRDS2015/output'
load(as.character(glue('/data/dasgupab/USRDS2015/data/biowulf/white_models_final{{i}}.rda')))
# load(file.path(data_path,'whites_models_final.rda')) # white models for discontinuation and transplant
...
# write_fst(dat, as.character(glue('output/simdata{{i}}_{{j}}.fst')))
